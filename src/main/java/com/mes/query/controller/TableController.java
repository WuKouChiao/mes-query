...
public class TableController {
    ...
    public ResultVO<PageVO<Map<String, Object>>> queryTable(
            ...
            @RequestParam(defaultValue = "desc") String order) throws SQLException {
        log.info("查询表 {}, page={}, size={}, filter={}, sort={}, order={}", tableName, page, size, filter, sort, order);
        return ResultVO.success(tableService.queryTable(tableName, page, size, filter, sort, order));
    }
}
